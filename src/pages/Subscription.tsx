...
const PLANS = [
  {
    ...
    badge: null,
    features: [
      { text: "2 skills listing", included: true },
      { text: "3 matches per month", included: true },
  ...
  },
  {
    ...
    badge: "Most Popular",
    features: [
      { text: "10 skills listing", included: true },
      { text: "15 matches per month", included: true },
      { text: "Unlimited messaging", included: true },
      { text: "Verified badge", included: true },
      { text: "Certificate generation", included: true },
      { text: "Video sessions", included: true },
      { text: "Priority in search", included: false },
      { text: "See who liked you", included: false },
    ],
  },
